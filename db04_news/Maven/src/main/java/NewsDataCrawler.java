...
public class NewsDataCrawler {
    ...
    // TODO: call the news search API to retrieve news articles of the given topic, using parameters page and pageSize;
    //  insert all articles returned into a MongoDB collection named "articles"
    ...
    // TODO: write an application that asks the user for a topic and retrieves 100 news articles from that topic,
    //  saving them in a MongoDB database; make sure to pause for 2m between API calls to avoid having your API key being locked out
    public static void main(String[] args) throws IOException, UnirestException {
        Scanner sc = new Scanner(System.in);
        System.out.println("Type a news topic: ");
